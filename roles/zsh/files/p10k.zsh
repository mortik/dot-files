# Generated by Powerlevel10k configuration wizard on 2020-12-18 at 21:09 CET.
...
# 2 lines, disconnected, full frame, sparse, fluent, transient_prompt,
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%B%n at %m'
